...
# ===== S&P500 Top/Bottom Movers =====
def get_sp500_top_bottom_movers():
    # S&P500 전체 티커/섹터/시총/볼륨/종가/변동률
    table = yf.download("^GSPC", period="2d", interval="1d", progress=False)  # S&P500 종가만
